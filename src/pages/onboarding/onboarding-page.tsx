...
export default function OnboardingPage() {
  ...
  return (
    <div className="flex-col-between min-h-[100dvh] bg-white px-[2rem] pt-[3.2rem] pb-[max(2.4rem,env(safe-area-inset-bottom))]">
      {/* content: 캐러셀 */}
      ...
      <div className="w-full">
        ...
        <button
          type="button"
          onClick={next}
          className="text-body2 h-[5.2rem] w-full rounded-[1.2rem] bg-black text-white"
        >
          {isLast ? '시작하기' : '다음'}
        </button>
      </div>
