...
import { STEPPER_COLOR, STEPPER_SIZE, StepState } from '@/pages/recommend/constants/stepper';
...
export default function StepDot({ index, state, stepLabel = '단계', doneLabel = '완료' }: Props) {
  ...
  return (
    <div className="caption1 flex-col-center">
      <div
        className={cn('grid place-items-center rounded-full', STEPPER_COLOR.dot[state])}
